...
with Session(engine) as session:
    ...
    test_task2 = Task(user="bledsoef", title="Across the country", gameTitle="A Game", status="Assigned", dateCompleted=None, expirationDate=datetime.now() + timedelta(days=1), quantity=5000, metric="steps", category="health", taskDescription="Walk 5000 steps!", rewardDescription="5 coins.")
    ...
    test_task5 = Task(user="bledsoef", title="Across the country", gameTitle="A Game", status="Assigned", dateCompleted=None, expirationDate=None, quantity=5000, metric="steps", category="health", taskDescription="Walk 5000 steps!", rewardDescription="5 coins.")
    test_task6 = Task(user="bledsoef", title="Across the country", gameTitle="A Third Game", status="Assigned", dateCompleted=datetime.now(), expirationDate=datetime.now(), quantity=5000, metric="steps", category="health", taskDescription="Walk 5000 steps!", rewardDescription="5 coins.")
